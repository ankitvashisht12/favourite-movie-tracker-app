  ...
  return (
    <>
      ...
      <div className="my-3 text-sm">
        ...
        <p>Cast: {typeof cast === "object" ? cast.join(", ") : cast}</p>
...
CastAndDirector.propTypes = {
  director: PropTypes.oneOfType([PropTypes.array, PropTypes.string]),
  cast: PropTypes.oneOfType([PropTypes.array, PropTypes.string]),
